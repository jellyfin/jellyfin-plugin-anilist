...
namespace Jellyfin.Plugin.AniList.Providers.AniList
{
    ...
    public class AniListApi(IHttpClientFactory httpClientFactory, ILogger<AniListApi> logger)
    {
        ...
        {
            logger.LogInformation($"Getting anime. Id: {id}");
        ...
        {
            logger.LogInformation($"Searching anime. Query: {title}");
        ...
        {
            logger.LogInformation($"Getting staff. Id: {id}");
        ...
        {
            logger.LogInformation($"Searching staff. Query: {query}");
